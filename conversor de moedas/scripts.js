function Converter() {
    ...
    var aparecerNaTela = document.getElementById("valorConvertido").innerHTML = "valor em euros: " + valorEmEuros + "£"
  ...
  function Converter2() {
    ...
    var aparecerNaTela = document.getElementById("valorConvertido2").innerHTML = "valor em dolar: " + valorEmDolares + "$"
  ...
  function Converter3() {
    ...
    var aparecerNaTela = document.getElementById("valorConvertido3").innerHTML = "valor em dolar: " + valorEmIenes + "¥"
